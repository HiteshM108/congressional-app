              ...
              children: [
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    trailing: Container(
                      child: Text(
                        "${widget.nutrients[0].toStringAsFixed(2)} kJ",
                        style: Theme.of(context).textTheme.bodyMedium,
                      ),
                    ),
                  ),
                  ...
                  child: ListTile(
                    leading: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: Colors.greenAccent),
                      child:
                          Icon(MdiIcons.fromString("food-drumstick-outline")),
                    ),
                    title: Text(
                      "Protein",
                      style: Theme.of(context).textTheme.titleMedium,
